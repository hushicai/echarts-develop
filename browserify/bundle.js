(function e(t, n, r) {
    ...
    1: [function(require, module, exports) {
        ...
        "echarts-without-esl/dist/chart/line": 2,
        "echarts-without-esl/dist/echarts": 3
    }],
        ...
        define("echarts/chart/line", ["require", "./base", "zrender/shape/Polyline", "../util/shape/Icon", "../util/shape/HalfSmoothPolygon", "../component/axis", "../component/grid", "../component/dataZoom", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/color", "../chart"], function(e) {
            ...
            return t.prototype = {
                ...
                _buildHorizontal: function(e, t, i, n) {
                    for (var a, o, r, s, l, h, d, m, c, p = this.series, u = i[0][0], V = p[u], U = this.component.xAxis.getAxis(V.xAxisIndex || 0), g = {}, f = 0, y = t; y > f && null != U.getNameByIndex(f); f++) {
                        ...
                        for (var b = 0, _ = i.length; _ > b; b++) {
                            ...
                            for (var x = 0, k = i[b].length; k > x; x++) u = i[b][x], V = p[u], m = V.data[f], c = this.getDataFromOption(m, "-"), g[u] = g[u] || [], n[u] = n[u] || {
                        ...
                        for (var v, b = 0, _ = i.length; _ > b; b++)
                            for (var x = 0, k = i[b].length; k > x; x++) u = i[b][x], V = p[u], m = V.data[f], c = this.getDataFromOption(m, "-"), "-" == c && this.deepQuery([m, V, this.option], "calculable") && (v = this.deepQuery([m, V], "symbolSize"), s += 2 * v + 5, r = s, this.shapeList.push(this._getCalculableItem(u, f, U.getNameByIndex(f), o, r, "horizontal")))
                    }
                ...
                _buildVertical: function(e, t, i, n) {
                    for (var a, o, r, s, l, h, d, m, c, p = this.series, u = i[0][0], V = p[u], U = this.component.yAxis.getAxis(V.yAxisIndex || 0), g = {}, f = 0, y = t; y > f && null != U.getNameByIndex(f); f++) {
                        ...
                        for (var v, b = 0, _ = i.length; _ > b; b++)
                            for (var x = 0, k = i[b].length; k > x; x++) u = i[b][x], V = p[u], m = V.data[f], c = this.getDataFromOption(m, "-"), "-" == c && this.deepQuery([m, V, this.option], "calculable") && (v = this.deepQuery([m, V], "symbolSize"), s -= 2 * v + 5, o = s, this.shapeList.push(this._getCalculableItem(u, f, U.getNameByIndex(f), o, r, "vertical")))
                    }
                    for (var L in g) g[L].length > 0 && (this.finalPLMap[L] = this.finalPLMap[L] || [], this.finalPLMap[L].push(g[L]), g[L] = []);
                ...
                _buildOther: function(e, t, i, n) {
                    for (var a, o = this.series, r = {}, s = 0, l = i.length; l > s; s++)
                        for (var h = 0, d = i[s].length; d > h; h++) {
                            ...
                            var p = this.component.yAxis.getAxis(c.yAxisIndex || 0),
                                u = p.getCoord(0);
                            r[m] = r[m] || [], n[m] = n[m] || {
                            ...
                            for (var V = 0, U = c.data.length; U > V; V++) {
                                ...
                                if (f instanceof Array) {
                                    var y = a.getCoord(f[0]),
                                        b = p.getCoord(f[1]);
                                    r[m].push([y, b, V, f[0], y, u]), n[m].min0 > f[0] && (n[m].min0 = f[0], n[m].minY0 = b, n[m].minX0 = y), n[m].max0 < f[0] && (n[m].max0 = f[0], n[m].maxY0 = b, n[m].maxX0 = y), n[m].sum0 += f[0], n[m].counter0++, n[m].min1 > f[1] && (n[m].min1 = f[1], n[m].minY1 = b, n[m].minX1 = y), n[m].max1 < f[1] && (n[m].max1 = f[1], n[m].maxY1 = b, n[m].maxX1 = y), n[m].sum1 += f[1], n[m].counter1++
                                }
                            }
                        }
                    ...
                    for (var o, s = "other" == n ? "horizontal" : n, m = this.series, c = e.length - 1; c >= 0; c--) {
                        ...
                        if (u.type === this.type && null != V)
                            for (var U = this._getBbox(p, s), g = this._sIndex2ColorMap[p], f = this.query(u, "itemStyle.normal.lineStyle.width"), y = this.query(u, "itemStyle.normal.lineStyle.type"), b = this.query(u, "itemStyle.normal.lineStyle.color"), _ = this.getItemStyleColor(this.query(u, "itemStyle.normal.color"), p, -1), x = null != this.query(u, "itemStyle.normal.areaStyle"), k = this.query(u, "itemStyle.normal.areaStyle.color"), v = 0, L = V.length; L > v; v++) {
                                ...
                                if (l.pack(S, m[p], p, 0, v, m[p].name), this.shapeList.push(S), x) {
                                    var K = new r({
                                        zlevel: u.zlevel,
                                        z: u.z,
                                        style: {
                                    ...
                                    l.pack(K, m[p], p, 0, v, m[p].name), this.shapeList.push(K)
                                }
                            }
                    }
                },
                ...
                addDataAnimation: function(e, t) {
                    ...
                    for (var l, h, d, m, c, p, u, V = 0, r = this.shapeList.length - 1; r >= 0; r--)
                        if (c = this.shapeList[r]._seriesIndex, o[c] && !o[c][3]) {
    ...
    3: [function(require, module, exports) {
        define("echarts", ["echarts/echarts"], function(e) {
            ...
            s.version = "2.2.6", s.dependencies = {
                zrender: "2.1.1"
            }, s.init = function(t, n) {
                var a = e("zrender");
            ...
            return i.prototype = {
                ...
                addData: function(e, t, i, n, r) {
                    ...
                    for (var l = e instanceof Array ? e : [
                            [e, t, i, n, r]
                        ], h = this.getOption(), d = this._optionRestore, m = this, c = 0, p = l.length; p > c; c++) {
                    ...
                    for (var W = this._chartList, w = 0, X = function() {
                            w--, 0 === w && s()
                        }, c = 0, p = W.length; p > c; c++) h.addDataAnimation && W[c].addDataAnimation && (w++, W[c].addDataAnimation(l, X));
            ...
            function e(e) {
                var t = this.os = {},
                    ...
                    f = e.match(/MSIE\s([\d.]+)/);
                return (i.webkit = !!n) && (i.version = n[1]), a && (t.android = !0, t.version = a[2]), s && !r && (t.ios = t.iphone = !0, t.version = s[2].replace(/_/g, ".")), o && (t.ios = t.ipad = !0, t.version = o[2].replace(/_/g, ".")), r && (t.ios = t.ipod = !0, t.version = r[3] ? r[3].replace(/_/g, ".") : null), l && (t.webos = !0, t.version = l[2]), h && (t.touchpad = !0), c && (t.blackberry = !0, t.version = c[2]), p && (t.bb10 = !0, t.version = p[2]), u && (t.rimtabletos = !0, t.version = u[2]), V && (i.playbook = !0), d && (t.kindle = !0, t.version = d[1]), m && (i.silk = !0, i.version = m[1]), !m && t.android && e.match(/Kindle Fire/) && (i.silk = !0), U && (i.chrome = !0, i.version = U[1]), g && (i.firefox = !0, i.version = g[1]), f && (i.ie = !0, i.version = f[1]), y && (e.match(/Safari/) || t.ios) && (i.safari = !0), b && (i.webview = !0), f && (i.ie = !0, i.version = f[1]), t.tablet = !!(o || V || a && !e.match(/Mobile/) || g && e.match(/Tablet/) || f && !e.match(/Phone/) && e.match(/Touch/)), t.phone = !(t.tablet || t.ipod || !(a || s || l || c || p || U && e.match(/Android/) || U && e.match(/CriOS\/([\d.]+)/) || g && e.match(/Mobile/) || f && e.match(/Touch/))), {
                    browser: i,
                    os: t,
            ...
            return t.prototype = {
                    ...
                    if (h.length > 0) {
                        if (this._lastItemTriggerId = -1, this._lastDataIndex != i || this._lastSeriesIndex != m[0]) {
                            ...
                            if ("function" == typeof a) {
                                ...
                                this._curTicket = NaN, a = a.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}");
                                ...
                                this._curTicket = NaN, a = this._encodeHTML(n.getNameByIndex(i));
                ...
                _showItemTrigger: function(e) {
                    if (this._curTarget) {
                        ...
                        } else this._lastItemTriggerId = NaN, n = this.deepQuery(V, "tooltip.showContent"), t = this.deepQuery(V, "tooltip.islandFormatter"), i = this.deepQuery(V, "tooltip.islandPosition");
                        this._lastDataIndex = -1, this._lastSeriesIndex = -1, this._lastItemTriggerId !== this._curTarget.id && (this._lastItemTriggerId = this._curTarget.id, "function" == typeof t ? (this._curTicket = (a.name || "") + ":" + h, this._tDom.innerHTML = t.call(this.myChart, {
                            ...
                            6: o,
                            7: h
                        }, this._curTicket, this._setContent)) : "string" == typeof t ? (this._curTicket = NaN, t = t.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}"), t = t.replace("{a0}", this._encodeHTML(a.name || "")).replace("{b0}", this._encodeHTML(m)).replace("{c0}", c instanceof Array ? c : this.numAddCommas(c)), t = t.replace("{d}", "{d0}").replace("{d0}", p || ""), t = t.replace("{e}", "{e0}").replace("{e0}", l.get(this._curTarget, "special2") || ""), this._tDom.innerHTML = t) : (this._curTicket = NaN, a.type === s.CHART_TYPE_RADAR && p ? this._tDom.innerHTML = this._itemFormatter.radar.call(this, a, m, c, p) : a.type === s.CHART_TYPE_EVENTRIVER ? this._tDom.innerHTML = this._itemFormatter.eventRiver.call(this, a, m, c, r) : this._tDom.innerHTML = "" + (null != a.name ? this._encodeHTML(a.name) + "<br/>" : "") + ("" === m ? "" : this._encodeHTML(m) + " : ") + (c instanceof Array ? c : this.numAddCommas(c))));
                ...
                _setSelectedMap: function() {
                    this.component.legend ? this._selectedMap = p.clone(this.component.legend.getSelectedMap()) : this._selectedMap = {}
                },
                                ...
                                if (m) {
                                    ...
                                    switch (d.type) {
                                        ...
                                        case s.CHART_TYPE_RADAR:
                                            ...
                                            var p = r.polarIndex || 0,
                                                u = this.component.polar.getVector(p, c, "max");
                                            this._event = {
                                                zrenderX: u[0],
                                                zrenderY: u[1]
                                            }, this._showPolarTrigger(p, c)
                                    }
                                } else {
                                    ...
                                    switch (d.type) {
                                        ...
                                        case s.CHART_TYPE_SCATTER:
                                            for (var c = e.dataIndex, a = 0, o = g.length; o > a; a++)
                                                if (null == g[a]._mark && l.get(g[a], "seriesIndex") == t && l.get(g[a], "dataIndex") == c) {
                                        ...
                                        case s.CHART_TYPE_RADAR:
                                            for (var c = e.dataIndex, a = 0, o = g.length; o > a; a++)
                                                if ("polygon" === g[a].type && l.get(g[a], "seriesIndex") == t && l.get(g[a], "dataIndex") == c) {
                                                    this._curTarget = g[a];
                ...
                _getItemGroupLocation: function() {
                    ...
                    switch (this.legendOption.x) {
                        case "center":
                            ...
                            break;
                        case "left":
                            f = m[3] + this.legendOption.borderWidth;
                            break;
                        case "right":
                            f = c - s - m[1] - m[3] - 2 * this.legendOption.borderWidth;
                            break;
                        default:
                            f = this.parsePercent(this.legendOption.x, c)
                    }
                    var y;
                    switch (this.legendOption.y) {
                        case "top":
                            y = m[0] + this.legendOption.borderWidth;
                            break;
                        case "bottom":
                            y = p - l - m[0] - m[2] - 2 * this.legendOption.borderWidth;
                            break;
                        case "center":
                            y = Math.floor((p - l) / 2);
                            break;
            ...
            function p(e, t) {
                ...
                var i = K(e),
                    n = i[3];
                return "undefined" == typeof n && (n = 1), e.indexOf("hsb") > -1 ? i = z(i) : e.indexOf("hsl") > -1 && (i = A(i)), t.indexOf("hsb") > -1 || t.indexOf("hsv") > -1 ? i = F(i) : t.indexOf("hsl") > -1 && (i = J(i)), i[3] = n, m(i, t)
            }
            ...
            function W(e, t) {
                ...
                for (var n = K(e), a = 0; 3 > a; a++) 1 === i ? n[a] = n[a] * (1 - t) | 0 : n[a] = (255 - n[a]) * t + n[a] | 0;
                return "rgb(" + n.join(",") + ")"
            }
            ...
            return t.prototype = {
                ...
                _getChainPoint: function() {
                    ...
                    for (var g, f, y, b, _, x = [], U = 0; p > U; U++) d = u[U], g = h[U].symbol && h[U].symbol.toLowerCase() || n, g.match("empty") ? (g = g.replace("empty", ""), y = !0) : y = !1, g.match("star") && (f = g.replace("star", "") - 0 || 5, g = "star"), t = h[U].textStyle ? l.merge(h[U].textStyle || {}, r) : r, b = t.align || "center", o ? (b = o > 0 ? "right" : "left", _ = [o * Math.PI / 180, d, m - 5]) : _ = !1, x.push({
                        x: d,
                        n: f,
                        isEmpty: y,
                        symbol: g,
            ...
            return n.inherits(t, i), t.prototype._start = function(e, t) {
                ...
                for (var p = this.createBackgroundShape(i.backgroundColor), u = m.n, V = m.x, U = m.y, g = m.r0, f = m.r, y = m.color, b = [], _ = Math.round(180 / u), x = 0; u > x; x++) b[x] = new r({
                    highlightStyle: {
                        x: V,
                        y: U,
                        r0: g,
            ...
            return document.createElement("canvas").getContext ? G_vmlCanvasManager = !1 : ! function() {
                ...
                function g(e, t) {
                    ...
                    var a = parseFloat(t.currentStyle.fontSize),
                        o = parseFloat(e.size);
                    return "number" == typeof e.size ? i.size = e.size : -1 != e.size.indexOf("px") ? i.size = o : -1 != e.size.indexOf("em") ? i.size = a * o : -1 != e.size.indexOf("%") ? i.size = a / 100 * o : -1 != e.size.indexOf("pt") ? i.size = o / .75 : i.size = a, i
                }
                ...
                }, Q.drawImage = function(e, t) {
                    var i, n, a, o, r, s, l, h, d = e.runtimeStyle.width,
                        m = e.runtimeStyle.height;
                    e.runtimeStyle.width = "auto", e.runtimeStyle.height = "auto";
                    var c = e.width,
                        p = e.height;
                    if (e.runtimeStyle.width = d, e.runtimeStyle.height = m, 3 == arguments.length) i = arguments[1], n = arguments[2], r = s = 0, l = a = c, h = o = p;
                    else if (5 == arguments.length) i = arguments[1], n = arguments[2], a = arguments[3], o = arguments[4], r = s = 0, l = c, h = p;
                    else {
                        if (9 != arguments.length) throw Error("Invalid number of arguments");
                        r = arguments[1], s = arguments[2], l = arguments[3], h = arguments[4], i = arguments[5], n = arguments[6], a = arguments[7], o = arguments[8]
                    }
                    var u = v(this, i, n),
                        V = [],
                        U = 10,
                        g = 10,
                        f = b = 1;
                    if (V.push(" <g_vml_:group", ' coordsize="', F * U, ",", F * g, '"', ' coordorigin="0,0"', ' style="width:', U, "px;height:", g, "px;position:absolute;"), 1 != this.m_[0][0] || this.m_[0][1] || 1 != this.m_[1][1] || this.m_[1][0]) {
                        var y = [],
                            f = this.scaleX_,
                            b = this.scaleY_;
                        y.push("M11=", this.m_[0][0] / f, ",", "M12=", this.m_[1][0] / b, ",", "M21=", this.m_[0][1] / f, ",", "M22=", this.m_[1][1] / b, ",", "Dx=", T(u.x / F), ",", "Dy=", T(u.y / F), "");
                        var _ = u,
                            x = v(this, i + a, n),
                            k = v(this, i, n + o),
                            L = v(this, i + a, n + o);
                        _.x = C.max(_.x, x.x, k.x, L.x), _.y = C.max(_.y, x.y, k.y, L.y), V.push("padding:0 ", T(_.x / F), "px ", T(_.y / F), "px 0;filter:progid:DXImageTransform.Microsoft.Matrix(", y.join(""), ", SizingMethod='clip');")
                    } else V.push("top:", T(u.y / F), "px;left:", T(u.x / F), "px;");
                    V.push(' ">'), (r || s) && V.push('<div style="overflow: hidden; width:', Math.ceil((a + r * a / l) * f), "px;", " height:", Math.ceil((o + s * o / h) * b), "px;", " filter:progid:DxImageTransform.Microsoft.Matrix(Dx=", -r * a / l * f, ",Dy=", -s * o / h * b, ');">'), V.push('<div style="width:', Math.round(f * c * a / l), "px;", " height:", Math.round(b * p * o / h), "px;", " filter:"), this.globalAlpha < 1 && V.push(" progid:DXImageTransform.Microsoft.Alpha(opacity=" + 100 * this.globalAlpha + ")"), V.push(" progid:DXImageTransform.Microsoft.AlphaImageLoader(src=", e.src, ',sizingMethod=scale)">'), (r || s) && V.push("</div>"), V.push("</div></div>"), this.element_.insertAdjacentHTML("BeforeEnd", V.join(""))
                }, Q.stroke = function(e) {
                    var t = [],
                        i = 10,
                        n = 10;
            ...
            return t.prototype.one = function(e, t, i) {
                ...
                V = {
                    ...
                    click: function(e, t) {
                        if (u(e) || t) {
                            ...
                            (i && i.clickable || !i) && this._clickThreshold < 5 && this._dispatchAgency(i, m.CLICK, e), this._mousemoveHandler(e)
                        }
                    },
                    dblclick: function(e, t) {
                        if (u(e) || t) {
                            ...
                            var i = this._lastHover;
                            (i && i.clickable || !i) && this._clickThreshold < 5 && this._dispatchAgency(i, m.DBLCLICK, e), this._mousemoveHandler(e)
                        }
                    },
                    ...
                    mousemove: function(e, t) {
                        if ((u(e) || t) && !this.painter.isLoading()) {
                            ...
                            this._draggingTarget || this._hasfound && this._lastHover.draggable ? a = "move" : this._hasfound && this._lastHover.clickable && (a = "pointer"), this.root.style.cursor = a, this._dispatchAgency(this._lastHover, m.MOUSEMOVE, e), (this._draggingTarget || this._hasfound || this.storage.hasHoverShape()) && this.painter.refreshHover()
                        }
                    },
                    ...
                    mousedown: function(e, t) {
                        if (u(e) || t) {
                            ...
                            this._lastMouseDownMoment = new Date, e = this._zrenderEventFixed(e), this._isMouseDown = 1, this._mouseDownTarget = this._lastHover, this._dispatchAgency(this._lastHover, m.MOUSEDOWN, e), this._lastDownButton = e.button
                        }
                    },
                    mouseup: function(e, t) {
                        (u(e) || t) && (e = this._zrenderEventFixed(e), this.root.style.cursor = "default", this._isMouseDown = 0, this._mouseDownTarget = null, this._dispatchAgency(this._lastHover, m.MOUSEUP, e), this._processDrop(e), this._processDragEnd(e))
                    },
                    ...
                    touchend: function(e, t) {
                        if (u(e) || t) {
                            ...
                            var i = new Date;
                            i - this._lastTouchMoment < m.touchClickDelay && (this._mobileFindFixed(e), this._clickHandler(e), i - this._lastClickMoment < m.touchClickDelay / 2 && (this._dblclickHandler(e), this._lastHover && this._lastHover.clickable && s.stop(e)), this._lastClickMoment = i), this.painter.clearHover()
                        }
                    }
                },
                U = function(e, t, o) {
            ...
            }, l.merge(U.prototype, c.prototype, !0), U
                            ...
                            if (U) {
                                ...
                                if (U) {
                                    ...
                                    for (var x = [], k = [], v = 0; U > v; v++) {
                                        x.push(u[v].time / _);
                                        var L = u[v].value;
                                        "string" == typeof L && (L = m.toArray(L), 0 === L.length && (L[0] = L[1] = L[2] = 0, L[3] = 1), y = !0), k.push(L)
                                    }
                                            ...
                                            if (0 !== d) {
                                                if (w = (o - x[v]) / d, c)
                                                    if (I = k[v], X = k[0 === v ? v : v - 1], K = k[v > U - 2 ? U - 1 : v + 1], S = k[v > U - 3 ? U - 1 : v + 2], f) r(X, I, K, S, w, w * w, w * w * w, l(e, V), b);
                                                        ...
                                                        var m;
                                                        y ? (m = r(X, I, K, S, w, w * w, w * w * w, E, 1), m = h(E)) : m = s(X, I, K, S, w, w * w, w * w * w), i(e, V, m)
                                                    } else if (f) a(k[v], k[v + 1], w, l(e, V), b);
                                                else {
                                                    var m;
                                                    y ? (a(k[v], k[v + 1], w, E, 1), m = h(E)) : m = n(k[v], k[v + 1], w), i(e, V, m)
                                                }
            ...
            function f(e, t, i, n, a, o, r, s, l, h) {
                ...
                for (var m, c, p = 0, u = -1, V = 0; d > V; V++) {
                    ...
                    l > f || (0 > u && (u = W.cubicExtrema(t, n, o, s, E), E[1] < E[0] && u > 1 && g(), m = W.cubicAt(t, n, o, s, E[0]), u > 1 && (c = W.cubicAt(t, n, o, s, E[1]))), p += 2 == u ? U < E[0] ? t > m ? 1 : -1 : U < E[1] ? m > c ? 1 : -1 : c > s ? 1 : -1 : U < E[0] ? t > m ? 1 : -1 : m > s ? 1 : -1)
                }
                return p
            }
            ...
            function _(e, t, i, n, a) {
                ...
                for (var g = "stroke" === i || "both" === i, _ = "fill" === i || "both" === i, x = 0; x < e.length; x++) {
                    ...
                    if (u || "M" === k.command) {
                        ...
                        c = v[v.length - 2], p = v[v.length - 1], u = !1, V && "A" !== k.command && (V = !1, d = c, m = p)
                    }
                    switch (k.command) {
                        case "M":
                            d = v[0], m = v[1];
                        ...
                        case "L":
                            ...
                            _ && (o += U(d, m, v[0], v[1], n, a)), d = v[0], m = v[1];
                            break;
                        case "C":
                            if (g && s(d, m, v[0], v[1], v[2], v[3], v[4], v[5], t, n, a)) return !0;
                            _ && (o += f(d, m, v[0], v[1], v[2], v[3], v[4], v[5], n, a)), d = v[4], m = v[5];
                            break;
                        case "Q":
                            if (g && l(d, m, v[0], v[1], v[2], v[3], t, n, a)) return !0;
                            _ && (o += y(d, m, v[0], v[1], v[2], v[3], n, a)), d = v[2], m = v[3];
                            break;
                        case "A":
                            var L = v[0],
                                W = v[1],
                            ...
                            _ && (o += b(L, W, X, I, I + K, 1 - v[7], T, a)), d = Math.cos(I + K) * w + L, m = Math.sin(I + K) * X + W;
                            break;
                        case "z":
            ...
            }, d.prototype.buildPath = function(e, t) {
                s("buildPath not implemented in " + this.type)
            }, d.prototype.getRect = function(e) {
            ...
            return i.prototype = {
                ...
                ondrop: function(e, t) {
                    if (this.isDrop && e.target && !t.dragIn) {
                        ...
                        } else i = s[o].data[r] || "-", null != i.value ? ("-" != i.value ? s[o].data[r].value = p.accAdd(s[o].data[r].value, d.get(a, "value")) : s[o].data[r].value = d.get(a, "value"), (this.type === h.CHART_TYPE_FUNNEL || this.type === h.CHART_TYPE_PIE) && (l && 1 === l.getRelatedAmount(i.name) && this.component.legend.del(i.name), i.name += this.option.nameConnector + d.get(a, "name"), l && l.add(i.name, a.style.color || a.style.strokeColor))) : "-" != i ? s[o].data[r] = p.accAdd(s[o].data[r], d.get(a, "value")) : s[o].data[r] = d.get(a, "value");
                ...
                addLabel: function(e, t, i, n, a) {
                    ...
                    if (s.show) {
                        ...
                        m.text = this._getLabelText(t, i, n, "emphasis"), m.textPosition = r.show ? e.style.textPosition : null == s.position ? "horizontal" === a ? "right" : "top" : s.position,
                            m.textColor = h.color, m.textFont = this.getFont(h), m.textAlign = h.align, m.textBaseline = h.baseline
                    }
                    return e
                },
                ...
                _buildMarkLine: function(e) {
                    ...
                    if (m) {
                        var c = new l({
                            ...
                            p = d[0];
                        if (p) {
                            U.merge(c.style, p.style), U.merge(c.highlightStyle = {}, p.highlightStyle), c.style.brushType = "stroke", c.zlevel = n.zlevel, c.z = n.z + 1, c.hoverable = !1;
                        ...
                        for (var m = n.data, c = [], p = this.zr.getWidth(), u = this.zr.getHeight(), g = 0; g < m.length; g++) {
                            ...
                            if (t(f[0]) && t(f[1])) {
                                ...
                                f[0].tooltip = y.tooltip || n.tooltip || {
                                    trigger: "item"
                                }, f[0].name = f[0].name || "", f[1].name = f[1].name || "", f[0].value = x, c.push({
                                    points: [
                    ...
                    var x = this.getItemStyleColor(f.color, t, o, i),
                        ...
                        W = new a({
                            style: {
                                ...
                                strokeColor: f.borderColor || x || m,
                                lineWidth: b
                            },
                            highlightStyle: {
                                color: h.match("empty") ? c : k || x || m,
                                strokeColor: y.borderColor || f.borderColor || k || x || m,
                                lineWidth: _
                            },
                ...
                buildPath: function(e, t) {
                    ...
                    if (0 !== n)
                        for (var a, o, r, s, l, h = 1e4, d = Math.ceil(n / h), m = i[0] instanceof Array, c = t.size ? t.size : 2, p = c, u = c / 2, V = 2 * Math.PI, U = 0; d > U; U++) {
                            ...
                            for (var g = a; o > g; g++)
                                if (t.random && (r = t["randomMap" + g % 20] / 100, p = c * r * r, u = p / 2), m ? (s = i[g][0], l = i[g][1]) : (s = i[g].x, l = i[g].y), 3 > p) e.rect(s - u, l - u, p, p);
            ...
            function t(e, t, i, n, a) {
                ...
                o = t.style.pointList;
                var m = o.length;
                m == s ? i.style.pointList = o : s > m ? i.style.pointList = o.concat(r.slice(m)) : i.style.pointList = o.slice(0, s), e.addShape(i), i.__animating = !0, e.animate(i.id, "style").when(n, {
                    pointList: r
                }).during(function() {
            ...
            return n.prototype.getStartPoint = function() {
                ...
                _iterate: function(e) {
                    ...
                    for (var c = new r(i, 4), p = [], u = l(), V = l(), U = 0, g = l(), f = l(), y = 0, h = 0; h < i.length; h++) {
                        var d = i[h];
                        if (!d.group) {
                            ...
                            for (var b = 0, _ = null, x = null, k = 0; k < p.length; k++) {
                                var v = p[k],
                                    L = 0;
                                v.group ? v.group !== x && (x = v.group, U = this._calculateGroupEdgeInk(v.group, d, u, V), L = v.group.ink + d.ink - U) : (U = this._calculateEdgeEdgeInk(d, v, u, V), L = v.ink + d.ink - U), L > b && (b = L, _ = v, m(f, V), m(g, u), y = U)
                            }
                            if (_) {
                                s += b;
                                var W;
                                _.group || (W = new a, o.push(W), W.addEdge(_)), W = _.group, m(W.mp0, g), m(W.mp1, f), W.ink = y, _.group.addEdge(d)
                            } else {
                                var W = new a;
            ...
            return function(e, n, a) {
                for (var o = e.length, r = [], s = 0, l = 1; o > l; l++) s += i.distance(e[l - 1], e[l]);
                var h = s / 5;
                h = o > h ? o : h;
                for (var l = 0; h > l; l++) {
                    var d, m, c, p = l / (h - 1) * (n ? o : o - 1),
                        u = Math.floor(p),
                        V = p - u,
                        U = e[u % o];
                    n ? (d = e[(u - 1 + o) % o], m = e[(u + 1) % o], c = e[(u + 2) % o]) : (d = e[0 === u ? u : u - 1], m = e[u > o - 2 ? o - 1 : u + 1], c = e[u > o - 3 ? o - 1 : u + 2]);
                    var g = V * V,
                        f = V * g;
                    r.push([t(d[0], U[0], m[0], c[0], V, g, f), t(d[1], U[1], m[1], c[1], V, g, f)])
                }
                return r
            }
            ...
            return function(e, i, n, a) {
                ...
                for (var u = 0, V = e.length; V > u; u++) {
                    ...
                    var g = t.distance(U, o),
                        f = t.distance(U, r),
                        y = g + f;
                    0 !== y && (g /= y, f /= y), t.scale(m, d, -g), t.scale(c, d, f);
                    var b = t.add([], U, m),
                        _ = t.add([], U, c);
        ...
        }), define("echarts/data/quickSelect", ["require"], function(e) {
            function t(e, t) {
                return e - t
            }
            ...
            function n(e, t, n, a, o) {
                for (var r = t; n > t;) {
                    var r = Math.round((n + t) / 2),
                        s = e[r];
                    i(e, r, n), r = t;
                    for (var l = t; n - 1 >= l; l++) o(s, e[l]) >= 0 && (i(e, l, r), r++);
                    if (i(e, n, r), r === a) return r;
                    a > r ? t = r + 1 : n = r - 1
                }
                return t
            }

            function a(e, i, a, o, r) {
                return arguments.length <= 3 && (o = i, r = 2 == arguments.length ? t : a, i = 0, a = e.length - 1), n(e, i, a, o, r)
            }
            return a
            ...
            return t.prototype = {
                ...
                _buildBackground: function() {
                    ...
                    for (var l = 0, h = i; h > l; l += _) c = this.getDataFromOption(u[l], 0), this.option.series[p].type == r.CHART_TYPE_K && (c = c[1]), isNaN(c) && (c = 0), "horizontal" == this.zoomOption.orient ? f.push([this._location.x + y * l, this._location.y + t - 1 - Math.round((c - U) / g * (t - 10))]) : f.push([this._location.x + 1 + Math.round((c - U) / g * (e - 10)), this._location.y + b * (h - l - 1)]);
                ...
                _buildFiller: function() {
                    this._fillerShae = {
                        ...
                        ondragend: this._ondragend,
                        _type: "filler"
                    }, "horizontal" == this.zoomOption.orient ? this._fillerShae.style = {
                ...
                _synScatterData: function(e, t) {
                    ...
                    "horizontal" == this.zoomOption.orient ? (i = l.x.max - l.x.min, n = this._zoom.start / 100 * i + l.x.min, a = this._zoom.end / 100 * i + l.x.min, i = l.y.max - l.y.min, o = this._zoom.start2 / 100 * i + l.y.min,
                        r = this._zoom.end2 / 100 * i + l.y.min) : (i = l.x.max - l.x.min, n = this._zoom.start2 / 100 * i + l.x.min, a = this._zoom.end2 / 100 * i + l.x.min, i = l.y.max - l.y.min, o = this._zoom.start / 100 * i + l.y.min, r = this._zoom.end / 100 * i + l.y.min);
                    var h;
                    ...
                    for (var d, m = 0, c = t.length; c > m; m++) d = t[m].value || t[m], d[0] >= n && d[0] <= a && d[1] >= o && d[1] <= r && s.push(t[m]);
                    return s
                },
                _setScale: function() {
            ...
            return t.prototype = {
                ...
                _buildAxisTick: function() {
                    var e, t = this.option.data,
                        ...
                        c = m > 0 ? -h : 0;
                    if (this.isHorizontal())
                        for (var p, u = "bottom" == this.option.position ? n.inside ? this.grid.getYend() - o - 1 : this.grid.getYend() + 1 : n.inside ? this.grid.getY() + 1 : this.grid.getY() - o - 1, V = c; i > V; V += h)(!l || l(V, t[V])) && (p = this.subPixelOptimize(this.getCoordByIndex(V) + (V >= 0 ? m : 0), s), e = {
                            _axisShape: "axisTick",
                            zlevel: this.getZlevelBase(),
                            z: this.getZBase(),
                            hoverable: !1,
                        ...
                        for (var U, g = "left" == this.option.position ? n.inside ? this.grid.getX() + 1 : this.grid.getX() - o - 1 : n.inside ? this.grid.getXend() - o - 1 : this.grid.getXend() + 1, V = c; i > V; V += h)(!l || l(V, t[V])) && (U = this.subPixelOptimize(this.getCoordByIndex(V) - (V >= 0 ? m : 0), s), e = {
                            _axisShape: "axisTick",
                            zlevel: this.getZlevelBase(),
                            z: this.getZBase(),
                            hoverable: !1,
                ...
                _buildSplitLine: function() {
                    ...
                    if (i -= d || "undefined" == typeof d && this.option.boundaryGap ? 1 : 0, this.isHorizontal())
                        for (var c, p = this.grid.getY(), u = this.grid.getYend(), V = 0; i > V; V += this._interval)(!h || h(V, t[V])) && (c = this.subPixelOptimize(this.getCoordByIndex(V) + m, r), e = {
                            zlevel: this.getZlevelBase(),
                            z: this.getZBase(),
                            hoverable: !1,
                            style: {
                        ...
                        for (var U, g = this.grid.getX(), f = this.grid.getXend(), V = 0; i > V; V += this._interval)(!h || h(V, t[V])) && (U = this.subPixelOptimize(this.getCoordByIndex(V) - m, r), e = {
                            zlevel: this.getZlevelBase(),
                            z: this.getZBase(),
                            hoverable: !1,
                            style: {
                ...
                _buildSplitArea: function() {
                    ...
                    if (n instanceof Array) {
                        ...
                        if (this.isHorizontal())
                            for (var d, m = this.grid.getY(), c = this.grid.getHeight(), p = this.grid.getX(), u = 0; r >= u; u += this._interval) s && !s(u, t[u]) && r > u || (d = r > u ? this.getCoordByIndex(u) + h : this.grid.getXend(), e = {
                                zlevel: this.getZlevelBase(),
                                z: this.getZBase(),
                                hoverable: !1,
                                style: {
                ...
                _calculateValue: function() {
                    if (isNaN(this.option.min - 0) || isNaN(this.option.max - 0)) {
                        ...
                        var d = "log" !== this.option.type ? this.option.boundaryGap : [0, 0],
                            m = Math.abs(this._max - this._min);
                        this._min = isNaN(this.option.min - 0) ? this._min - Math.abs(m * d[0]) : this.option.min - 0, this._max = isNaN(this.option.max - 0) ? this._max + Math.abs(m * d[1]) : this.option.max - 0, this._min === this._max && (0 === this._max ? this._max = 1 : this._max > 0 ? this._min = this._max / this.option.splitNumber != null ? this.option.splitNumber : 5 : this._max = this._max / this.option.splitNumber != null ? this.option.splitNumber : 5), "time" === this.option.type ? this._reformTimeValue() : "log" === this.option.type ? this._reformLogValue() : this._reformValue(this.option.scale)
            ...
            function h(e, t, n) {
                var s, h = n || +_.slice(-1),
                    ...
                    f = o(e, -1, 1),
                    y = o(t, -1);
                if (r(U, u), r(f, u, 1), r(y, u), n ? s = m(f, y, h) : h = d(f, y), i(e) && i(t) && e * t >= 0) {
            ...
            function f(e, t, i) {
                ...
                for (var g = n.length; g--;) {
                    ...
                    for (var f = m.length; f--;) l % m[f][0] === 0 && (d /= m[f][1]);
                    p[g] = [i, l, h, d].join(), c[g] = {
                        secs: i,
                        step: l,
                        delta: h,
                        score: d
            ...
            function n() {
                ...
                isFinite(e) || isFinite(t) ? isFinite(e) ? isFinite(t) ? e > t && (t = [e, e = t][0]) : t = e : e = t : e = t = 1, c = U.logPositive, null == c && (c = t > 0 || 0 === e), y = c ? e : -t, b = c ? t : -e, T > y && (y = T), T > b && (b = T)
            }
            ...
            function o() {
                for (var e = [], t = 0, i = _.length; i > t; t++) e[t] = (c ? 1 : -1) * _[t];
                !c && e.reverse();
                var n = s(),
                    a = n.value2Coord,
                    o = a(e[0]),
            ...
            var c, p, u, V, U, g, f, y, b, _, x = e("./number"),
                k = Math,
                v = k.log,
                L = k.pow,
                W = k.abs,
